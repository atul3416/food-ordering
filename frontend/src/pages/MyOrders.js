...
import { FaBoxOpen, FaInfoCircle, FaMapMarkedAlt, FaMinus, FaPlus, FaShoppingCart, FaTrash } from 'react-icons/fa'
    ...
    return (
        <PublicLayout>
            <div className='container py-5'>
                <h2 className='text-center mb-4'><FaBoxOpen className='text-warning me-2' size={50} />My Orders</h2>
                    ...
                    orders.map((order, index) => (
                        <div className='card mb-4 shadow-sm' key={index}>
                            <div className='card-body d-flex align-items-center flex-wrap'>
                                <div className='me-2'>
                                    <FaBoxOpen className='text-warning' size={40} />
                                </div>
